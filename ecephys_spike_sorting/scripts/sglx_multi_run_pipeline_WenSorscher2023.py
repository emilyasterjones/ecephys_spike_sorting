...
sessions = sessions.iloc[[59, 65, 57, 46]].reset_index()
chanMap_list = ['AO1_v3','AO2_v2','AO4_v2','AO5_v3']
...
for a, row in sessions.iterrows(): 
    ...
    for spec in run_specs:
        ...
        for i, prb in enumerate(prb_list):
            ...
            chanMap = os.path.join(imro_dir, chanMap_list[a]+'.mat')
